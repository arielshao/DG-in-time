...
# Interpolation degree = 10

# T=1, tol=1e-10  CG4 in space k=h^2--> expected order O(k^2)
# |  r   |    h      |  k= h^2  |  L^2 norm   |   rate   |  
# |------|:----------|:--------:|:-----------:|:--------:|
# |  4   |5.0000e-1  |2.5000e-1 | 8.2580e-3   |   ----   |
# |      |2.5000e-1  |6.2500e-2 | 4.8451e-4   |  2.0456  | 
...
# |  r   | h         |  k= h^2  |  L^2 norm   |   rate   |  
# |------|:----------|:--------:|:-----------:|:--------:|
# |  5   |5.0000e-1  |2.5000e-1 | 6.5806e-4   |   ----   |
# |      |2.5000e-1  |6.2500e-2 | 1.8482e-5   |  2.5770  | 
# |      |2.0000e-1  |4.0000e-2 | 5.7757e-6   |  2.6063  |  
# |      |1.2500e-1  |1.5625e-2 | 5.6859e-7   |  2.4662  |   
...
# |  r   | h         |  k= h^2  |  L^2 norm   |   rate   |  
# |------|:----------|:--------:|:-----------:|:--------:|
# |  6   |5.0000e-1  |2.5000e-1 | 4.4105e-5   |   ----   |
# |      |2.5000e-1  |6.2500e-2 | 6.3450e-7   |  3.0596  | 
# |      |2.0000e-1  |4.0000e-2 | 1.5579e-7   |  3.1467  |  
# |      |1.2500e-1  |1.5625e-2 | 9.4363e-9   |  2.9829  |   
# |      |1.0000e-1  |1.0000e-2 | 2.4728e-9   |  3.0008  | 
...
error_4= np.array([ 8.2580e-3, 4.8451e-4, 1.8660e-4, 2.9049e-5, 1.1718e-5]);
error_5= np.array([ 6.5806e-4, 1.8482e-5, 5.7757e-6, 5.6859e-7, 1.8397e-7]);
error_6= np.array([ 4.4105e-5, 6.3450e-7, 1.5579e-7, 9.4363e-9, 2.4728e-9]);
...
title('Plot of $||u- u_\mathrm{DG}||_{H^1(\Omega)}+||\dot{u}- \dot{u}_\mathrm{DG}||_{L^2(\Omega)}$ versus 1/k for DG4 in time')
legend(loc = 'best')
grid()
savefig('1D_nonlinear_wave_DG4_L2error.png', dpi=300, bbox_inches='tight')
