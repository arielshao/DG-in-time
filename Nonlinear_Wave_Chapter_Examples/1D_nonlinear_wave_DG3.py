...
# |------|:----------|:--------:|:-----------:|:--------:|
# |  3   |5.0000e-1  |2.5000e-1 | 8.5255e-2   |   ----   |
# |      |2.5000e-1  |6.2500e-2 | 9.6890e-3   |  1.5687  | 
# |      |2.0000e-1  |4.0000e-2 | 4.7880e-3   |  1.5794  |  
# |      |1.2500e-1  |1.5625e-2 | 1.1826e-3   |  1.4876  |   
# |      |1.0000e-1  |1.0000e-2 | 6.0129e-4   |  1.5156  | 
 
# T=1, tol=1e-10 CG4 in space k=h^2--> expected order O(k^2)

# |  r   | h         |  k= h^2  |  L^2 norm   |   rate   |  
# |------|:----------|:--------:|:-----------:|:--------:|
# |  4   |5.0000e-1  |2.5000e-1 | 9.4281e-3   |   ----   |
# |      |2.5000e-1  |6.2500e-2 | 5.5121e-4   |  2.0481  | 
# |      |2.0000e-1  |4.0000e-2 | 1.9138e-4   |  2.3703  |  
# |      |1.2500e-1  |1.5625e-2 | 3.2968e-5   |  1.8710  |   
# |      |1.0000e-1  |1.0000e-2 | 1.2794e-5   |  2.1210  | 

# T=1, tol=1e-10 CG5 in space k=h^2--> expected order O(k^{5/2})

# |  r   | h         |  k= h^2  |  L^2 norm   |   rate   |  
# |------|:----------|:--------:|:-----------:|:--------:|
# |  5   |5.0000e-1  |2.5000e-1 | 9.8184e-4   |   ----   |
# |      |2.5000e-1  |6.2500e-2 | 1.9364e-5   |  2.8320  | 
# |      |2.0000e-1  |4.0000e-2 | 6.2627e-6   |  2.5293  |  
# |      |1.2500e-1  |1.5625e-2 | 6.6943e-7   |  2.3786  |   
# |      |1.0000e-1  |1.0000e-2 | 2.2772e-7   |  2.4162  | 
...
# |  r   | h         |  k= h^2  |  L^2 norm   |   rate   |  
# |------|:----------|:--------:|:-----------:|:--------:|
# |  6   |5.0000e-1  |2.5000e-1 | 2.5638e-4   |   ----   |
# |      |2.5000e-1  |6.2500e-2 | 8.0834e-7   |  4.1545  | 
# |      |2.0000e-1  |4.0000e-2 | 1.7537e-7   |  3.4240  |  
# |      |1.2500e-1  |1.5625e-2 | 1.0075e-8   |  3.0392  |   
# |      |1.0000e-1  |1.0000e-2 | 2.6799e-9   |  2.9673  | 
...
error_3= np.array([ 8.5255e-2, 9.6890e-3, 4.7880e-3, 1.1826e-3, 6.0129e-4]);
error_4= np.array([ 9.4281e-3, 5.5121e-4, 1.9138e-4, 3.2968e-5, 1.2794e-5]);
error_5= np.array([ 9.8184e-4, 1.9364e-5, 6.2627e-6, 6.6943e-7, 2.2772e-7]);
error_6= np.array([ 2.5638e-4, 8.0834e-7, 1.7537e-7, 1.0075e-8, 2.6799e-9]);
...
title('Plot of $||u- u_\mathrm{DG}||_{H^1}+||\dot{u}- \dot{u}_\mathrm{DG}||_{L^2}$ versus 1/k for DG3 in time')
legend(loc = 'best')
grid()
savefig('1D_nonlinear_wave2_DG3_L2error.png', dpi=300, bbox_inches='tight')
